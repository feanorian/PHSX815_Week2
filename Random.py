...
This is the modified Random class for HW 3 in Computational Physics. Here, we use the multinomial generator in Numpy to produce the deviates
...
class Random:
    ...
    def Exponential(self, beta=1.):
      ...
      return X
    # this is a function that returns an array dice rolls with each number in the array is the count of the number of time a number lands
    def Category(self, trials, prob):
